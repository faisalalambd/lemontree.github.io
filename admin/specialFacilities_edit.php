...
$id = $_GET['id'];
$sql = "SELECT * FROM specialFacilities where id=$id";
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Edit:special facilities </h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="specialFacilities_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
