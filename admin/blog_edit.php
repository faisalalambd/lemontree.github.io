        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <!-- ############################## Form ############################## -->
                    <form action="blog_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="summernote" value="<?php echo $short_description ?>" name="short_description" required></textarea>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Long Description</strong></label>
                                <div class="col-sm-9">
                                    <textarea class="summernote" value="<?php echo $long_description ?>" name="long_description" required></textarea>
                                </div>
                            </div>
