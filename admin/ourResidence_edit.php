...
$id = $_GET['id'];
$sql = "SELECT * FROM ourResidence where id=$id";
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Edit: Our Residence</h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="ourResidence_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
